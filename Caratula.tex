...
\textsc{\large Laboratorio 3}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries TITULO }\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
{\large 10 de Febrero de 2016}\\[5cm] % Date, change the \today to a set date if you want to be precise
