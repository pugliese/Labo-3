...
\begin{figure}[h]
  ...
  \caption{Circuito de dos mallas utilizado para la experiencia cuya fuente constante $\varepsilon$ generaba corrientes $i_1$ e $i_2$ que circulaban por las resistencias $R$ y la resistencia $r$. En las posiciones $ A_i$ se ubicó el multimetro para medir estas corrientes.}
