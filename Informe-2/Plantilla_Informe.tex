...
Considerando un circuito cerrado de una unica malla compuesto por una fuente de voltaje constante $V_{0}$, una resistencia $R$ y un capacitor $C$, las leyes de Kirchoff dictan que la ecuación que rige la evolución del sistema es $V_{0} = \frac{q(t)}{C}+IR$. Entonces, tomando como condición inicial $q(0)=0$ la solución de la ecuación es:
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{RC-Caida_en_Resistencia}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{RC-Caida_en_Capacitor}
  \caption{Variacion del Potencial en funcion del tiempo}
  \label{fig:RC-CC}
\end{figure}
...
\begin{subfigure}{0.5\textwidth}
\includegraphics[scale=0.35]{RL-Caida_en_Inductancia}
  \caption{Medicion sobre la Inductancia}
  \label{subfig:RL_CI}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[scale=0.35]{RL-Caida_en_Resistencia}
  \caption{Medicion sobre la Resistencia}
  \label{subfig:RL_CR}
\end{subfigure}
