...
Como se ha dicho, una de las leyes basicas de los circuitos en general es la Ley de Ohm (\textbf{OHM}). Es por esto que la primer parte del trabajo se desarrolló en torno a la comprobación empírica de (\textbf{OHM}). El montaje del sistema fue simple; consistiendo en una Fuente de Alimentación Programable de 3 canales, un multimetro digital y una resistencia variable por decadas. La Fuente de Alimentacion actuó como una fuente de voltaje constante, que se conectó en serie con el multimetro y la resistencia variable. Esto permitió generar un circuito de una única malla que consiste en una resistencia y una fuente de voltaje constante (Ver \textbf{Fig Circuito basico})
